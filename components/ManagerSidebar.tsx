...
export default function ManagerSidebar({ children }: ManagerSidebarProps) {
  ...
  const menuItems = [
    ...
    { icon: Package, label: 'Bookings', path: '/manager/bookings' },
    { icon: Calendar, label: 'Upcoming Events', path: '/manager/upcoming-events' },
    { icon: Users, label: 'Users', path: '/manager/users' },
    { icon: Briefcase, label: 'Staff', path: '/manager/staff' },
    { icon: Calendar, label: 'Calendar', path: '/manager/calendar' },
    { icon: BarChart3, label: 'Reports', path: '/manager/reports' },
    { icon: TrendingUp, label: 'Transactions', path: '/manager/transactions' },
          ...
          <div className="flex items-center flex-shrink-0 px-6 py-6 border-b border-gray-200">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Manager Portal</p>
              </div>
            </motion.div>
          </div>
              ...
              return (
                <motion.button
                  ...
                  className={`w-full flex items-center gap-4 px-4 py-3 rounded-xl transition-all group ${
                    active
                      ? 'bg-gradient-to-r from-primary/20 to-yellow-600/20 border-l-4 border-primary'
            ...
            <div className="flex items-center gap-3 px-3 py-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-gray-900 truncate">
                  {managerData?.displayName || 'Manager'}
                </p>
                <p className="text-xs text-gray-600 truncate">{managerData?.email || 'manager@eventcash.com'}</p>
              </div>
            </div>
            <motion.button
            ...
            {menuItems.map((item) => {
              ...
              return (
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  onClick={() => handleNavigation(item.path)}
                  className="flex flex-col items-center gap-1 px-2 py-2 transition-colors group"
                >
                  <div
                    className={`w-12 h-12 flex items-center justify-center rounded-xl transition-all ${
                      active
                        ? 'bg-gradient-to-br from-primary to-yellow-600 text-white'
