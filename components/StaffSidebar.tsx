...
export default function StaffSidebar({ children }: StaffSidebarProps) {
  ...
  const staffUser = typeof window !== 'undefined' 
    ? JSON.parse(localStorage.getItem('staffUser') || '{}')
    : {};
          ...
          <div className="flex-shrink-0 border-t border-gray-200 p-4">
            <div className="flex items-center gap-3 px-3 py-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-600 truncate">{staffUser?.email || 'staff@eventcash.com'}</p>
              </div>
            </div>
            <motion.button
                  ...
                  {profileOpen && (
                    ...
                    >
                      <div className="p-4 border-b border-gray-200 bg-gradient-to-br from-primary/5 to-yellow-600/5">
                        ...
                        <p className="text-xs text-gray-600 mt-1">{staffUser?.email}</p>
                      </div>
                      <div className="p-2">
                        <button
                          onClick={() => {
